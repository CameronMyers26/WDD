...
function setBackgroundColor(color) {
    ...
    let pagecolor = document.getElementById("q1-container");
...
function redButtonClicked() {
    ...
    let color = "red";
    let q1 = document.getElementById("q1-btn-red")
    q1.onclick = setBackgroundColor(color);
...
function yellowButtonClicked() {
    let color = "yellow";
    let q1 = document.getElementById("q1-btn-yellow")
    q1.onclick = setBackgroundColor(color);
}
...
function greenButtonClicked() {
    let color = "green";
    let q1 = document.getElementById("q1-btn-green")
    q1.onclick = setBackgroundColor(color);
}
...
function lightBlueButtonClicked() {
    let color = "lightblue";
    let q1 = document.getElementById("q1-btn-lightblue")
    q1.onclick = setBackgroundColor(color);
}
...
function blueButtonClicked() {
    let color = "navy";
    let q1 = document.getElementById("q1-btn-blue")
    q1.onclick = setBackgroundColor(color);
}
